...
import 'email_airlines_model.dart';
export 'email_airlines_model.dart';
...
class _EmailAirlinesWidgetState extends State<EmailAirlinesWidget>
  ...
  late EmailAirlinesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmailAirlinesModel());
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Manage and Send email to Airlines',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            StreamBuilder<
                                                List<AirlinesDirectoryRecord>>(
                                              stream:
                                                  queryAirlinesDirectoryRecord(),
                                              builder: (context, snapshot) {
                                                // Customize what your widget looks like when it's loading.
                                                if (!snapshot.hasData) {
                                                  return Center(
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                '${listViewClaimsRecord.flightNumber} - ${listViewClaimsRecord.departure} to ${listViewClaimsRecord.destination}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .titleSmall
                                                                    .override(
                                                              ...
                                                              Text(
                                                                'Ref: ${listViewClaimsRecord.leadRef != null ? "CA-${listViewClaimsRecord.leadRef!.id.substring(0, 8).toUpperCase()}" : "---"}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelSmall
                                                                    .override(
