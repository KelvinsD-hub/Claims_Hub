...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFFC4836A);
  ...
  late Color hint = const Color(0xFFA0A0A0);
  late Color divider = const Color(0xFFE0E0E0);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color success = const Color(0xFF6B8E5E);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFCF6679);
  late Color info = const Color(0xFFFFFFFF);

  late Color hint = const Color(0xFF666666);
  late Color divider = const Color(0xFF2C2C2C);
}
