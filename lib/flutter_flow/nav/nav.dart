...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: EmailAirlinesWidget.routeName,
          path: EmailAirlinesWidget.routePath,
          builder: (context, params) => EmailAirlinesWidget(),
        ),
        FFRoute(
          name: StaffsWidget.routeName,
          path: StaffsWidget.routePath,
        ...
        FFRoute(
          name: TermsOfEngagmentWidget.routeName,
          path: TermsOfEngagmentWidget.routePath,
          builder: (context, params) => TermsOfEngagmentWidget(
            claimRef: params.getParam(
              'claimRef',
        ...
        FFRoute(
          name: EvidenceFormWidget.routeName,
          path: EvidenceFormWidget.routePath,
          builder: (context, params) => EvidenceFormWidget(
            claimRef: params.getParam(
              'claimRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: LetterOfAuthorityWidget.routeName,
          path: LetterOfAuthorityWidget.routePath,
          builder: (context, params) => LetterOfAuthorityWidget(
            claimsRef: params.getParam(
              'claimsRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['claims'],
        ...
        FFRoute(
          ...
          builder: (context, params) => ClaimsDetailsWidget(
            claimsRef: params.getParam(
              'claimsRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: WaitingApprovalWidget.routePath,
          builder: (context, params) => WaitingApprovalWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EditEvidenceFormWidget.routeName,
          path: EditEvidenceFormWidget.routePath,
          builder: (context, params) => EditEvidenceFormWidget(
            claimRef: params.getParam(
              'claimRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: ClaimsSubmitedWidget.routeName,
          path: ClaimsSubmitedWidget.routePath,
          builder: (context, params) => ClaimsSubmitedWidget(
            claimsRef: params.getParam(
              'claimsRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: ClaimStatusWidget.routeName,
          path: ClaimStatusWidget.routePath,
          builder: (context, params) => ClaimStatusWidget(
            claimRef: params.getParam(
              'claimRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: EligibilityCheckerWidget.routeName,
          path: EligibilityCheckerWidget.routePath,
          builder: (context, params) => const EligibilityCheckerWidget(),
        ),
        FFRoute(
          name: SolicitorsWidget.routeName,
          path: SolicitorsWidget.routePath,
          requireAuth: true,
          builder: (context, params) => const SolicitorsWidget(),
        ),
