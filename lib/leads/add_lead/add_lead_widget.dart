...
import 'add_lead_model.dart';
export 'add_lead_model.dart';

/// Create a component that creates or take leads for CRM with the following
/// Textfields, name, phone number, email, source a dropdown, and message.
///
/// add any other necessary details to the component
class AddLeadWidget extends StatefulWidget {
  const AddLeadWidget({super.key});
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              onChanged: (val) =>
                                  safeSetState(() => _model.sourceValue = val),
                              height: 50.0,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                hintText: 'Enter additional notes or message',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                                      font: GoogleFonts.inter(
