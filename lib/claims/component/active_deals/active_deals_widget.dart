...
/// Create a component that qeuries Lists of an Active Deals of a CRM with the
/// following headings, Clients, Task, Due date, Revenue, and Status.
///
/// add any necessary details to the component. the headings should be in
/// horizontal line with the lists of deals below the headings
class ActiveDealsWidget extends StatefulWidget {
  const ActiveDealsWidget({super.key});
