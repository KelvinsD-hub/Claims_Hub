...
import 'schema/solicitor_exports_record.dart';
import 'schema/activity_logs_record.dart';
import 'schema/airlines_directory_record.dart';
...
export 'schema/solicitor_exports_record.dart';
export 'schema/activity_logs_record.dart';
export 'schema/airlines_directory_record.dart';
...
Future<int> queryClaimsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
/// Functions to query SolicitorExportsRecords (as a Stream and as a Future).
Future<int> querySolicitorExportsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SolicitorExportsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SolicitorExportsRecord>> querySolicitorExportsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SolicitorExportsRecord.collection,
      SolicitorExportsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SolicitorExportsRecord>> querySolicitorExportsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AirlinesDirectoryRecords (as a Stream and as a Future).
Future<int> queryAirlinesDirectoryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AirlinesDirectoryRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AirlinesDirectoryRecord>> queryAirlinesDirectoryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AirlinesDirectoryRecord.collection,
      AirlinesDirectoryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AirlinesDirectoryRecord>> queryAirlinesDirectoryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
