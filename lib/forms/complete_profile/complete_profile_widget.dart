...
/// Create a component with the necessary fields for an authenticated user to
/// update the user document.
///
/// add the following textfields, profileImage, full name, Email address,
/// Phone number, Address, Bio etc. add any necessary details to the component
...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  void initState() {
    ...
    _model.adressTextFieldTextController ??= TextEditingController();
    _model.adressTextFieldFocusNode ??= FocusNode();
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        safeSetState(() =>
                            _model.isDataUploading_uploadData1mctt = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadData1mctt = false;
                        }
                        if (selectedUploadedFiles.length ==
                                selectedMedia.length &&
                            downloadUrls.length == selectedMedia.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadData1mctt =
                                selectedUploadedFiles.first;
                            _model.uploadedFileUrl_uploadData1mctt =
                                downloadUrls.first;
                          });
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: _model.adressTextFieldTextController,
                            focusNode: _model.adressTextFieldFocusNode,
                            autofocus: false,
                            textCapitalization: TextCapitalization.words,
                            textInputAction: TextInputAction.next,
                            obscureText: false,
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  if (valueOrDefault<bool>(
                    ...
                    context.pushNamed(WaitingApprovalWidget.routeName);
                  }
                },
                text: 'Save Changes',
              ...
              FFButtonWidget(
                onPressed: () async {
                  safeSetState(() {
                    ...
                    _model.adressTextFieldTextController?.clear();
                    _model.cityTextFieldTextController?.clear();
                    _model.bioTextFieldTextController?.clear();
                  });
                  context.safePop();
                },
                text: 'Cancel',
