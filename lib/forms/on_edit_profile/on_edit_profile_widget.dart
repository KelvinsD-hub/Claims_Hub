...
import 'on_edit_profile_model.dart';
export 'on_edit_profile_model.dart';
...
class OnEditProfileWidget extends StatefulWidget {
  const OnEditProfileWidget({
    super.key,
  ...
  @override
  State<OnEditProfileWidget> createState() => _OnEditProfileWidgetState();
}

class _OnEditProfileWidgetState extends State<OnEditProfileWidget> {
  late OnEditProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnEditProfileModel());
                              ...
                              TextFormField(
                                controller:
                                    _model.addressTextFieldTextController ??=
                                        TextEditingController(
                                  text: containerUsersRecord.address,
                                ),
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await widget!.userRef!.update(createUsersRecordData(
                        ...
                        address: _model.addressTextFieldTextController.text,
