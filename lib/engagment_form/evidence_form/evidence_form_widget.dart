...
import 'evidence_form_model.dart';
export 'evidence_form_model.dart';

/// Create a page for a Client Intake form, that is Evidence Collector with
/// the following textfields.
///
/// Full Name	As it appears on the ticket
/// Email/Phone/BVN	To send updates
/// Airline Name	e.g., Air Peace, Dana Air, etc.
/// Flight Date	Date of the disruption
/// Booking Ref (PNR)	6-digit alphanumeric code
/// Duration of Delay	How many hours/minutes?
/// Reason Given	What did the airline tell you?
/// Bank Details	For remitting your portion of the win
/// Uploads	[Button: Upload Boarding Pass] [Button: Upload ID]
class EvidenceFormWidget extends StatefulWidget {
  ...
  static String routeName = 'EvidenceForm';
  static String routePath = '/evidenceForm';
...
class _EvidenceFormWidgetState extends State<EvidenceFormWidget> {
  ...
  void initState() {
    ...
    _model.phonrNoTextController ??= TextEditingController();
    _model.phonrNoFocusNode ??= FocusNode();

    _model.ninTextController ??= TextEditingController();
    _model.ninFocusNode ??= FocusNode();

    _model.passportIDTextController ??= TextEditingController();
    _model.passportIDFocusNode ??= FocusNode();
    ...
    _model.flightDateTextController ??=
        TextEditingController(text: dateTimeFormat("yMMMd", _model.datePicked));
    _model.flightDateFocusNode ??= FocusNode();

    _model.pnrTextController ??= TextEditingController();
    _model.pnrFocusNode ??= FocusNode();

    _model.durationTextController ??= TextEditingController();
    _model.durationFocusNode ??= FocusNode();

    _model.departureTextController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ClaimsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final evidenceFormClaimsRecord = snapshot.data!;
              ...
              child: Scaffold(
                ...
                body: SafeArea(
                  ...
                  child: StreamBuilder<LeadsRecord>(
                    stream: LeadsRecord.getDocument(
                        evidenceFormClaimsRecord.leadRef!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                            ...
                            child: Column(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Continued Client Intake Form - Please fill out all required information',
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          TextFormField(
                                            controller:
                                                _model.phonrNoTextController,
                                            focusNode: _model.phonrNoFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                                            ...
                                            validator: _model
                                                .phonrNoTextControllerValidator
                                                .asValidator(context),
                                          ),
                                          TextFormField(
                                            controller:
                                          ...
                                          TextFormField(
                                            controller:
                                                _model.passportIDTextController,
                                            focusNode:
                                                _model.passportIDFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                                            ...
                                            validator: _model
                                                .passportIDTextControllerValidator
                                                .asValidator(context),
                                          ),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            'Airline Name / Flight Number / Amount',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                          ...
                                          TextFormField(
                                            controller: _model
                                                .airlineNameTextController,
                                            focusNode:
                                                _model.airlineNameFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                                          ...
                                          TextFormField(
                                            ...
                                            validator: _model
                                                .claimAmountTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ].divide(SizedBox(height: 8.0)),
                                      ),
                                          ...
                                          FFButtonWidget(
                                            ...
                                            text: valueOrDefault<String>(
                                              _model.datePicked != null
                                                  ? '${dateTimeFormat("MMMEd", _model.datePicked)} / ${dateTimeFormat("jm", _model.datePicked)}'
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            AuthUserStreamWidget(
                                              builder: (context) =>
                                                  TextFormField(
                                                controller: _model
                                                    .flightDateTextController,
                                                focusNode:
                                                    _model.flightDateFocusNode,
                                                autofocus: false,
                                                textInputAction:
                                                    TextInputAction.next,
                                                obscureText: false,
                                                ...
                                                validator: _model
                                                    .flightDateTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          Text(
                                            valueOrDefault<String>(
                                              _model.datePicked != null
                                                  ? '${dateTimeFormat("MMMEd", _model.datePicked)} / ${dateTimeFormat("jm", _model.datePicked)}'
                                                  : 'Select the Date & Time ',
                                              'Select the Date & Time on the button above',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          TextFormField(
                                            controller:
                                                _model.pnrTextController,
                                            focusNode: _model.pnrFocusNode,
                                            autofocus: false,
                                            textCapitalization:
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            'Flight departure point, and Destination',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                          ...
                                          Text(
                                            'Enter take off point and the destination below.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                                  font: GoogleFonts.inter(
                                          ...
                                          TextFormField(
                                            controller:
                                                _model.departureTextController,
                                            focusNode:
                                                _model.departureFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                                            ...
                                            validator: _model
                                                .departureTextControllerValidator
                                                .asValidator(context),
                                          ),
                                          TextFormField(
                                            controller: _model
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            'What is your Reason for the Claims',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              hintText:
                                                  'Enter the reason provided by the airline',
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'For remitting your portion of the win',
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                                  font: GoogleFonts.inter(
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadDataUg8ca =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          ScaffoldMessenger.of(
                                                                  context)
                                                              .hideCurrentSnackBar();
                                                          _model.isDataUploading_uploadDataUg8ca =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFiles_uploadDataUg8ca =
                                                                selectedUploadedFiles;
                                                            _model.uploadedFileUrls_uploadDataUg8ca =
                                                                downloadUrls;
                                                          });
                                                          showUploadMessage(
                                                              context,
                                    ...
                                    try {
                                      ...
                                      if (context.mounted) {
                                        ScaffoldMessenger.of(context)
                                          ...
                                          backgroundColor: Color(0xFF42B71D),
                                        ));

                                        context.pushNamed(
                                          TermsOfEngagmentWidget.routeName,
                                          queryParameters: {
                                            'claimRef': serializeParam(
