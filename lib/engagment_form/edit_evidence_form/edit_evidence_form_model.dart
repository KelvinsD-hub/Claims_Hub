...
import 'dart:ui';
import '/index.dart';
import 'edit_evidence_form_widget.dart' show EditEvidenceFormWidget;
...
class EditEvidenceFormModel extends FlutterFlowModel<EditEvidenceFormWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in EditEvidenceForm widget.
  ...
  bool isDataUploading_uploadDataUg8 = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadDataUg8 = [];
  List<String> uploadedFileUrls_uploadDataUg8 = [];
